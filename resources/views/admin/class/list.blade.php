      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right">
            <a href="{{ url('admin/class/add') }}" class="btn btn-primary">Add New {{ !empty($title)? $title : '' }}</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                  ...
                  <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ Request::get('name') }}" placeholder="Class Name" >
                            </div>
                        <div class="form-group col-md-3">
                            <label>Date</label>
