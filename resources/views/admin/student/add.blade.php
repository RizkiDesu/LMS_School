                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="admission_number" required value="{{ old('admission_number')}}" placeholder="Admission Number" >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" name="date_of_birth" required value="{{ old('date_of_birth')}}" placeholder="Date of Birth" >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="blood_grup" value="{{ old('blood_grup')}}" placeholder="Blood Grup">
